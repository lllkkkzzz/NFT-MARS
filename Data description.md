...
## 1.3. Power law distribution analysis
...
3. Number of tokens for which mean of the second half transactions' price is greater than the first half transactions' price (add a table)


# 3. Item features preparation (이건 좀 겉도는 감이 있음 따로 빼던지 아님 놔두던지)
