...
if __name__ == '__main__':
    ...
    NFT_MARS = Net(args)
    wandb.init(project="nft", name=f'{args.collection}_{args.loss_alpha}', entity="k73623407-worcester-polytechnic-institute", config={k: v for k, v in args._get_kwargs()})
    NFT_MARS.run()
    wandb.finish()
