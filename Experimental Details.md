## Data sets (We conducted experiments on four real-world NFT transaction datasets BAYC, Cool Cats, Doodles, and Meebits. (See Section \ref{sec:Data} for details.)  
