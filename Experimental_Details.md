...
<br>
Baseline models’ hyperparameters were also tuned, in regards to embedding size, learning rate, and dropout ratio. Specific details like the optimal hyperparameter values, hyperparameter search range can be found in 'Baseline_models(Others)/hyper' and 'Baseline_models(Others)/hyper_result'.
